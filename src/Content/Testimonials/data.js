export const testimonials_data = {
    'es' : [
        {
            "name": 'Alicia Salomone',
            "position": 'Directora de Relaciones Internacionales y Académica de la Facultad de Filosofía y Humanidades UCH',
            "text": '(...) me di cuenta de que no era tan complejo como parecía, que se puede diseñar a través del programa Genially con mucha facilidad, presentaciones interactivas que ofrecen un montón de recursos, y luego también subir ese material a la plataforma no era complejo, era cuestión de aprender algunos mecanismos (...) a veces, tenemos el temor de que esto implique mucho trabajo, por un lado, y yo digo sí, es verdad, hay que trabajar un poco antes, pero luego el curso se desarrolla con mucha facilidad porque el material ya está preparado, entonces se reduce mucho la presión sobre el docente. (...) para mí la plataforma y el método que promueve la plataforma es excelente y no me canso de recomendársela a mis colegas y sobre todo de que comprendan que tienen que vencer la resistencia que todos tenemos siempre a cambiar nuestros hábitos, pero siempre los impulso a que lo hagan.',
            "img": '/images/testimonials/05_testimonios_AliciaSalomone.jpg'
        },
        {
            "name": 'Rodrigo Pascual',
            "position": 'Académico del Departamento de Ingeniería Mecánica de la Facultad de Ciencias Físicas y Matemáticas UCH' ,
            "text": '(...) Es potente porque ya las herramientas están probadas, las formas de evaluación sumativa y formativa han sido probadas. Entonces, eso ayuda a que lo que se haga sea de clase mundial. (...) Me gustó mucho el concepto porque creo en la clase invertida, en el flip classroom que le llaman, como medio para enriquecer los aprendizajes de los chicos. [...] Es una manera de implementar aprendizaje activo, donde el alumno va guiando su proceso de aprendizaje.',
        ...
        },
        {
            ...
            "img": '/images/testimonials/07_testimonios_PamelaRojas.jpg'
        },
        {
            "name": 'Daniela Ejsmentewicz',
        ...
        },
        {
            ...
            "position": 'Coordinadora Académica, Programa de Inglés de Postgrado',
            "text": 'El trabajo con EOL ha sido excelente en todo ámbito y destaco el equipo altamente capacitado que me apoyó a través del ciclo completo de diseño, implementación y evaluación de nuestros talleres. En particular, agradezco al equipo de Diseño Instruccional que me apoyó enormemente en la adaptación y creación del contenido y a todos quienes ayudaron a crear un producto refinado de la más alta calidad.',
            "img": '/images/testimonials/01_testimonios_FranciscaMorales.jpg'
        },
        {
            "name": 'Isaac Peña',
        ...
        {
            "name": 'Fernando Ulloa',
            "position": 'Profesor de Historia UCH y Doctorando en Estudios Interculturales UCT',
            "text": 'Trabajar con la plataforma EOL es un desafío constante a la creatividad, por cuanto las posibilidades se amplían e implican una puesta en escena desde lo estético. También favorece el ser sintético y concreto en cuanto a lo que se espera de determinada actividad y en cuánto plazo. Ya no se reduce el "subir un material" a atiborrar una cuenta de correo o reproducir un texto, ya no solo se trata de añadir una imagen o linkear un video en una presentación secuencial; sino más bien, se trata de diseñar formas, unidades o módulos que harán más interactivo lo asincrónico. Permite que los/las/les estudiantes  se nutran de una visualidad que los antiguos sistemas reducían a vínculos e hipervínculos (pasos forzados donde hacer click), mientras que al presente EOL permite que ellos también se apropien de la tecnología y comuniquen, ya no solo a través de texto. Contar con un equipo y una VTI que brinda apoyo constante y resuelve dudas, también es otra de las posibilidades que brinda este sistema: co-crear.',
            "img": '/images/testimonials/03_testimonios_FernandoUlloa.jpg'
        },
        {
            "name": 'Alma',
            "position": 'Estudiante de Literatura 4° año',
            "text": 'EOL es pulenta: tiene una interfaz bacán, novedosa y apañadora con sus múltiples herramientas y posibilidades para aprender y conectar en una sola experiencia la U, el cerebro y el mundo.',
            "img": '/images/testimonials/04_testimonios_Alma.jpg'
        }
    ]
}
